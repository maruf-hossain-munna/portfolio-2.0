    ...
    return (
        <div id='projects'>
            ...
            <div className='my-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 gap-y-12'>
                <ProjectsCard
                    title="Miro"
                    image='/images/web/miro.png'
                    category='Next js website'
                    description="This is a business website converted from figma. Create custom Tabs & Carousel components not using any ui library.using React fast marquee package for auto scrolling animation."
                    gitHubLink='https://github.com/maruf-hossain-munna/miro'
                    liveLink="https://miroo-lac.vercel.app/"
                />
                <ProjectsCard
                    title="Mired"
                    ...
                    liveLink="https://mired.vercel.app/"
                />
                <ProjectsCard
                    title="E-Shop"
